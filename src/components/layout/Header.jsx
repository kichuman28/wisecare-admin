...
const Header = () => {
  return (
    <header className="bg-white shadow-sm h-16 flex items-center justify-between px-4 md:px-8 border-b border-gray-100">
      <div className="flex items-center flex-1 min-w-0">
        <h2 className="text-xl md:text-2xl font-semibold text-gray-800 truncate">Wise Care</h2>
